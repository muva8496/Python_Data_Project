...
## 2 .How are in-demand skills tending for Data Analysis?
...
![Trending Top Skills for Data Analysis in Canada]
(2__Project\Images\output.png)
*Line graph visualizing the trending top skills for data analysts in the Canada in 2023*
